		...
		<div class="container"> 
			<h3 class="w3ls-title w3ls-title1">Order Detail</h3>  
                        ...
                        <table style="border-color: #0280e1; border-style: solid; margin-left: 200px;">
                            ...
                            <tr>
                                <th style="width: 150px;text-align: center; height: 40px; border-bottom-style: solid;border-color: #0280e1;" colspan="2">Order Status</th>
                                <th style="width: 150px;text-align: center; height: 40px; border-bottom-style: solid;border-color: #0280e1;"colspan="2"><%= status%></th>
                            </tr>
                        </table>
		</div>
	</div>
