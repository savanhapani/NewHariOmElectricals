...
public final class setting_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h3 class=\"w3ls-title w3ls-title1\">Change Password...?</h3>  \n");
      out.write("\t\t\t<div class=\"login-body\">\n");
      out.write("                            <form action=\"setting.jsp\" method=\"post\">\n");
      out.write("\t\t\t\t\t<input type=\"password\" class=\"user\" name=\"sepassword\" placeholder=\"new password\" required=\"\">\n");
      out.write("\t\t\t\t\t<input type=\"password\" name=\"senewpassword\" class=\"lock\" placeholder=\"confirm password\" required=\"\">\n");
                              ...
                              try
                                {
                                    ...
                                    if(action!=null)
                                    {
                                        ...
                                        if(npass.equals(cpss))
                                        {
                                            ...
                                            int i=st.executeUpdate("update customer set cust_password='"+npass+"'");
                                            if(i>0)
                                            {
